...
@class ARGCustomPageViewController;
@protocol ARGCustomPageViewControllerSubclassing<NSObject>
/// 若子类遵循协议 必需实现协议方法
@required
/**
 *  @brief  分页控制器将要滑动到指定页
 ...
 */
- (void)pageViewController:(nonnull ARGCustomPageViewController *)pageViewController willTransitionToViewController:(nonnull UIViewController *)viewController index:(NSUInteger)index progress:(CGFloat)progress;
 ...
 *  @param index              当前页面索引
 */
- (void)pageViewController:(nonnull ARGCustomPageViewController *)pageViewController didTransitionToViewController:(nonnull UIViewController *)viewController index:(NSUInteger)index;

@end

@interface ARGCustomPageViewController : UIViewController
